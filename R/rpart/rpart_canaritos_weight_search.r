...
#Parametros entrada
karchivo_actual       <-  "paquete_premium_dias.txt"
...
#------------------------------------------------------------------------------
for( canaritos_idx  in  c(0.1, 0.2, 0.5, 0.75, 1.0 ) )
{
#Inicio del programa
t0       <-  Sys.time()
...
dataset_actual <-  dataset_actual[  foto_mes>=201805 & foto_mes<=201902, ]
gc()
...
for( vpeso_positivos  in c(1,2,5,10,15,20,30, 39, 50, 80) )
{
...
cat(  "modelo original",
      ...
      "\tpeso_positivos:", vpeso_positivos,
